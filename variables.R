...
variables_numericas_hogar <- c(
  "Ingreso total del hogar corregido (promedio)" = "ytotcorh",
...
variables <- c(variables_numericas_personas,
               variables_numericas_hogar,
               ...
               "Personas en situación de pobreza multidimensional" = "pobreza_multi",
               "Personas pertenecientes a pueblos originarios" = "originario",
               "Personas de origen extranjero" = "extranjero",
               "Personas en situación laboral inactiva" = "inactivos",
               "Personas en situación laboral desocupada" = "desocupados",
               "Afiliados a Fonasa" = "fonasa",
               ...
               "Porcentaje de personas pertenecientes a pueblos originarios" = "originario_p",
               "Porcentaje de personas de origen extranjero" = "extranjero_p",
               ...
               #
               "Porcentaje de afiliados a Fonasa" = "fonasa_p",
               "Porcentaje de hogares con menores de 18 años" = "men18c_p",
               "Porcentaje de hogares con mayores de 60 años" = "may60c_p",
               "Porcentaje de viviendas propias" = "vivienda_propia_p",
               "Porcentaje de viviendas pequeñas (30m cuadrados o menos)" = "vivienda_pequeña_p",
               "Porcentaje de hogares con jefatura femenina" = "hogar_jefatura_femenina_p",
               "Porcentaje de hogares en situación de hacinamiento (4 personas o más)" = "hacinamiento_p"
)